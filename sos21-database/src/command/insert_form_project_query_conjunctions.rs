...
pub async fn insert_form_project_query_conjunctions<'a, E>(
    conn: E,
    form_id: Uuid,
    ...
    E: sqlx::Executor<'a, Database = sqlx::Postgres>,
{
    ...
    sqlx::query!(
        r#"
INSERT INTO form_project_query_conjunctions (
    form_id,
    category,
    attributes
)
...
"#,
    ...
    .execute(conn)
    .await
    .context("Failed to insert to form project query conjunctions")?;
