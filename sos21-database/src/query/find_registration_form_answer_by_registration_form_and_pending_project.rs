...
pub async fn find_registration_form_answer_by_registration_form_and_pending_project<'a, E>(
    conn: E,
    ...
    E: sqlx::Executor<'a, Database = sqlx::Postgres>,
{
    sqlx::query_as!(
        ...
        "SELECT * FROM registration_form_answers WHERE registration_form_id = $1 AND pending_project_id = $2",
