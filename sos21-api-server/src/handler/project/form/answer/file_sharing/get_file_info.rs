...
use sos21_use_case::get_project_form_answer_shared_file;
...
impl From<get_project_form_answer_shared_file::Error> for Error {
    fn from(err: get_project_form_answer_shared_file::Error) -> Error {
        match err {
            get_project_form_answer_shared_file::Error::ProjectNotFound => Error::ProjectNotFound,
            get_project_form_answer_shared_file::Error::FormNotFound => Error::FormNotFound,
            get_project_form_answer_shared_file::Error::FormAnswerNotFound => {
                Error::FormAnswerNotFound
            }
            get_project_form_answer_shared_file::Error::FileSharingNotFound => {
                Error::FileSharingNotFound
            }
            get_project_form_answer_shared_file::Error::InvalidSharing => Error::InvalidFileSharing,
        }
    }
}
...
pub async fn handler(ctx: Login<Context>, request: Request) -> HandlerResult<Response, Error> {
    ...
    let file = get_project_form_answer_shared_file::run(&ctx, input).await?;
