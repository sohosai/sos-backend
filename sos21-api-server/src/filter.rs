...
pub fn endpoints(
    ...
    warp::path("health.liveness")
        ...
        .or(warp::path("project.form.get")
            .and(warp::get())
            .and(with_app.clone())
            .and(with_auth.clone())
            .and(warp::query())
            .and_then(handler::project::form::get))
        .or(warp::path("project.form.list")
            .and(warp::get())
            .and(with_app.clone())
            .and(with_auth.clone())
            .and(warp::query())
            .and_then(handler::project::form::list))
        .or(warp::path("project.form.answer.get")
            .and(warp::get())
            .and(with_app.clone())
            .and(with_auth.clone())
            .and(warp::query())
            .and_then(handler::project::form::answer::get))
        .or(warp::path("form_answer.get")
            .and(warp::get())
            .and(with_app.clone())
            .and(with_auth.clone())
            .and(warp::query())
            .and_then(handler::form_answer::get))
        .or(warp::path("form.answer.list")
            .and(warp::get())
            .and(with_app.clone())
            .and(with_auth.clone())
            .and(warp::query())
            .and_then(handler::form::answer::list))
        .or(warp::path("form.answer.export")
            .and(warp::get())
            .and(with_app.clone())
            .and(with_auth.clone())
            .and(warp::query())
            .and_then(handler::form::answer::export))
        .or(warp::path("project.form.answer")
            .and(warp::post())
            .and(with_app.clone())
            .and(with_auth.clone())
            .and(warp::body::json())
