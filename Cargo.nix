  ...
  internal = rec {
    ...
    crates = {
      ...
      "reqwest 0.10.10" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "default-tls" "hyper-tls" "json" "native-tls" "native-tls-crate" "serde_json" "tokio-tls" ];
      };
      "reqwest 0.11.0" = rec {
        crateName = "reqwest";
        version = "0.11.0";
      ...
      "slack-hook2" = rec {
        crateName = "slack-hook2";
        version = "0.10.0";
        edition = "2018";
        sha256 = "0bdff1mqs6kkmdcpzlg64ws82vglbnn94gz4chbwixm96k5irdbm";
        authors = [
